...
angular.module("RDash").controller("LoadDashBoard",['$scope','$location',
    function LoadDashBoard($scope,$location) {
        ...
        $scope.msg = "";
        $scope.errorMsg = "";
        $scope.github_by_user = [{"id":1,"data":"ninjatrench"}];
        $scope.github_by_repo = [{"id":1,"data":"ninjatrench/DeveloperHorizon"}];
        $scope.bitbucket = [{"id":1,"data":"jagguli/aioweb"}];
        $scope.bugzilla = [{"id":1,"data":"screen splash"}];
        $scope.udd = [{"id":1,"data":"daniel@pocock.pro"}];
        $scope.ubuntu = false;
        $scope.debian = false;
        $scope.direct = "";
        ...
        $scope.verifyData = function(){
            ...
            AlertsCtrl().newAlert("error","error1");
...
angular.module("RDash").controller("LoadSession",['$scope','$location',
function LoadSession($scope,$location){
    ...
    $scope.go = function(){
        ...
        console.log($scope.showLoadedSession);
    };
